...
StateGDPIndustryDF <- lapply(c(3,6,10,11,12,34,35,36,45,51,56,60,64,65,69,70,76,79,82,84,85,86),function(x) {
  ...
  beaGet(beaSpecs,BEAKey) %>%
    ...
    pivot_longer(8:ncol(.),names_to = "Quarter",values_to = "GDP_CurrentUSD") %>%
